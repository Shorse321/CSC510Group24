...
class TestStatusAccessControl:
    ...
    def test_update_status_customer_cannot_update_any_order(self, client, app, 
                                                            test_customer_user, test_staff_user):
    ...
    def test_update_status_staff_can_update_any_order(self, client, app, 
                                                      test_staff_user, pending_order):
    ...
    def test_update_status_admin_can_update_any_order(self, client, app, 
                                                      test_admin_user, pending_order):
    ...
    def test_customer_can_view_own_order(self, client, app, test_customer_user, pending_order):
    ...
    def test_cancel_order_customer_can_cancel_own(self, client, app, test_customer_user, pending_order):
    ...
    def test_cancel_order_customer_cannot_cancel_other(self, client, app, 
                                                       test_customer_user, test_staff_user):
    ...
    def test_cancel_order_staff_cannot_cancel_through_route(self, client, app, 
                                                            test_staff_user, test_customer_user, 
                                                            pending_order):
    ...
    def test_full_workflow_staff_managing_order(self, client, app, test_staff_user, pending_order):
    ...
    def test_full_workflow_customer_viewing_order(self, client, app, 
                                                  test_customer_user, pending_order):
    ...
    def test_isolation_multiple_users(self, client, app):
        ...
        with app.app_context():
            ...
            order1 = Order(user_id=user1.id, total_price=Decimal('5.00'), status='Pending')
            order2 = Order(user_id=user2.id, total_price=Decimal('5.00'), status='Pending')
            ...
            for order in [order1, order2]:
                ...
                oi = OrderItem(order_id=order.id, menu_item_id=item_obj.id,
                             name=item_obj.name, price=item_obj.price, quantity=1)
                db.session.add(oi)
        ...
        response = client.post(f'/status/cancel/{order2_id}',
                              content_type='application/json')
