...
class TestStatusRoutes:
    ...
    def test_manage_orders_staff_access(self, client, app, test_staff_user, pending_order):
    ...
    def test_manage_orders_admin_access(self, client, app, test_admin_user, pending_order):
    ...
    def test_manage_orders_customer_denied(self, client, app, test_customer_user, pending_order):
    ...
    def test_manage_orders_shows_all_orders(self, client, app, test_staff_user, 
                                           test_customer_user, multiple_orders_various_statuses):
    ...
    def test_update_status_requires_login(self, client):
        ...
        response = client.post('/status/update',
                              data=json.dumps({'order_id': 1, 'status': 'Preparing'}),
                              content_type='application/json')
        
        assert response.status_code == 302
    
    def test_update_status_staff_success(self, client, app, test_staff_user, pending_order):
    ...
    def test_update_status_customer_own_order(self, client, app, test_customer_user, pending_order):
    ...
    def test_update_status_customer_other_order(self, client, app, test_customer_user, test_staff_user):
    ...
    def test_update_status_invalid_transition(self, client, app, test_staff_user, pending_order):
    ...
    def test_cancel_order_customer_success(self, client, app, test_customer_user, pending_order):
        """Test customer can cancel their own order."""
        self.login(client, 'customer1', 'password123')
        
        response = client.post(f'/status/cancel/{pending_order}',
                              content_type='application/json')
    ...
    def test_cancel_order_staff_success(self, client, app, test_staff_user, test_customer_user, pending_order):
    ...
    def test_cannot_cancel_delivered_order(self, client, app, test_customer_user, delivered_order):
        """Test cannot cancel delivered order."""
        self.login(client, 'customer1', 'password123')
        
        response = client.post(f'/status/cancel/{delivered_order}',
                              content_type='application/json')
    ...
    def test_cannot_cancel_already_cancelled(self, client, app, test_customer_user, cancelled_order):
        """Test cannot cancel already cancelled order."""
        self.login(client, 'customer1', 'password123')
        
        response = client.post(f'/status/cancel/{cancelled_order}',
                              content_type='application/json')
    ...
    def test_cancel_nonexistent_order(self, client, test_customer_user):
        ...
        response = client.post('/status/cancel/99999',
                              content_type='application/json')
    ...
    def test_cancel_other_user_order(self, client, app, test_customer_user, test_staff_user):
        ...
        response = client.post(f'/status/cancel/{other_order_id}',
                              content_type='application/json')
