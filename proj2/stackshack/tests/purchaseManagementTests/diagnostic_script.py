...
print("\nFor coverage report:")
print("  pytest tests/purchaseManagementTests/ -v --cov=controllers.order_controller --cov=models.order --cov=routes.order_routes --cov-report=html --cov-report=term")