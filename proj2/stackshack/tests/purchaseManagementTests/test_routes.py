...
class TestOrderRoutes:
    ...
    def test_order_history_multiple_orders(self, client, app, test_user, multiple_orders):
    ...
    def test_get_ingredients_by_category_sauce(self, client, app, sample_menu_items):
        ...
        assert isinstance(data, list)
        sauce_items = [item for item in data if 'sauce' in item['name'].lower() or 'ketchup' in item['name'].lower()]
    ...
    def test_get_ingredients_returns_correct_fields(self, client, app, sample_menu_items):
        ...
        if len(data) > 0:
            item = data[0]
            required_fields = ['id', 'name', 'price', 'description', 'is_healthy', 'image_url']
    ...
    def test_get_ingredients_partial_category_match(self, client, app, sample_menu_items):
    ...
    def test_create_order_form_authenticated(self, client, app, test_user, sample_menu_items):
    ...
    def test_create_order_form_displays_content(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_correct_total(self, client, app, test_user, sample_menu_items):
        ...
        with app.app_context():
            ...
            expected_total = Decimal(str(bun.price)) + (Decimal(str(patty.price)) * 2) + Decimal(str(cheese.price))
        
        response = client.post('/orders/place', data=form_data, follow_redirects=True)
        
        with app.app_context():
            order = Order.query.filter_by(user_id=test_user).order_by(Order.ordered_at.desc()).first()
    ...
    def test_place_order_multiple_items(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_large_quantities(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_invalid_quantity_format(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_redirect_on_success(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_flash_message(self, client, app, test_user, sample_menu_items):
        ...
        assert response.status_code == 200
        assert b'success' in response.data.lower() or b'placed' in response.data.lower() or b'order' in response.data.lower()
    
    # ==================== EDGE CASE TESTS ====================
    
    def test_place_order_with_decimal_quantity(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_with_negative_quantity(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_very_long_item_name(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_with_very_high_price(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_mixed_valid_invalid_items(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_whitespace_in_quantities(self, client, app, test_user, sample_menu_items):
    ...
    def test_place_order_after_logout_fails(self, client, app, test_user, sample_menu_items):
    ...
    def test_multiple_orders_same_session(self, client, app, test_user, sample_menu_items):
