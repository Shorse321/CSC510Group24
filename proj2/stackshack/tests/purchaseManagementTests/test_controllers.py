...
class TestOrderController:
    ...
    def test_create_new_order_success(self, app, test_user, sample_menu_items):
        ...
        with app.app_context():
            ...
            success, message, order = OrderController.create_new_order(test_user, item_data)
    ...
    def test_create_new_order_negative_quantity(self, app, test_user, sample_menu_items):
    ...
    def test_create_new_order_large_quantity(self, app, test_user, sample_menu_items):
        ...
        with app.app_context():
            item_data = [
                (sample_menu_items[2], '1.00', 50, 'Cheddar Cheese')
            ]
    ...
    def test_create_new_order_multiple_same_item(self, app, test_user, sample_menu_items):
        """Test creating an order with multiple quantities of the same item."""
        with app.app_context():
            item_data = [
                (sample_menu_items[1], '3.50', 3, 'Beef Patty')
            ]
    ...
    def test_create_new_order_verify_order_items(self, app, test_user, sample_menu_items):
    ...
    def test_create_new_order_invalid_price_format(self, app, test_user, sample_menu_items):
        """Test creating an order with invalid price format."""
        with app.app_context():
            item_data = [
                (sample_menu_items[0], 'invalid', 1, 'Classic Bun')
            ]
    ...
    def test_create_new_order_invalid_quantity_format(self, app, test_user, sample_menu_items):
        """Test creating an order with invalid quantity format."""
        with app.app_context():
            item_data = [
                (sample_menu_items[0], '1.50', 'invalid', 'Classic Bun')
            ]
    ...
    def test_create_new_order_database_rollback(self, app, test_user, sample_menu_items):
        ...
        with app.app_context():
            ...
            item_data = [
                (sample_menu_items[0], 'invalid_price', 1, 'Classic Bun')
            ]
